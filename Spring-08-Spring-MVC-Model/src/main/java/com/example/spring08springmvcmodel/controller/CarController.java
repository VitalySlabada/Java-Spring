...
public class CarController {
    ...
    public String carInfo2(@RequestParam(value= "make",required = false) String make,@RequestParam(required = false) Integer year, Model model){
        System.out.println(make);
    ...
    @RequestMapping("/info/{make}/{year}") //localhost:8080/car/info/subaru
